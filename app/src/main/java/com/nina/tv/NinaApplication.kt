...
@HiltAndroidApp
class NinaApplication : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        try {
            ...
            Log.w("NinaApplication", "Failed to install Conscrypt: ${e.message}")
        }
        ...
        try {
            ...
            Log.w("NinaApplication", "Failed to initialize NiceHttp client (API ${Build.VERSION.SDK_INT}): ${e.message}")
        }
