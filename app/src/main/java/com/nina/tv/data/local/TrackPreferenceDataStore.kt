...
internal fun PersistedTrackPreference.toTrackPreference(): com.nina.tv.ui.screens.player.PlayerRuntimeController.TrackPreference? {
    val audio = if (audioLanguage != null || audioName != null || audioTrackId != null) {
        com.nina.tv.ui.screens.player.PlayerRuntimeController.RememberedTrackSelection(
    ...
    val subtitle = when (subtitleType) {
        "INTERNAL" -> com.nina.tv.ui.screens.player.PlayerRuntimeController.RememberedSubtitleSelection.Internal(
            track = com.nina.tv.ui.screens.player.PlayerRuntimeController.RememberedTrackSelection(
                language = subtitleLanguage,
                name = subtitleName,
                trackId = subtitleTrackId
            )
        )
        "ADDON" -> com.nina.tv.ui.screens.player.PlayerRuntimeController.RememberedSubtitleSelection.Addon(
            id = addonSubtitleId ?: "",
            url = addonSubtitleUrl ?: "",
            language = subtitleLanguage ?: "",
            addonName = addonSubtitleAddonName ?: ""
        )
        "DISABLED" -> com.nina.tv.ui.screens.player.PlayerRuntimeController.RememberedSubtitleSelection.Disabled
        else -> null
    }

    if (audio == null && subtitle == null) return null
    return com.nina.tv.ui.screens.player.PlayerRuntimeController.TrackPreference(
        audio = audio,
        subtitle = subtitle
    )
}
