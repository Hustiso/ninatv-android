...
import com.nina.tv.data.remote.dto.mdblist.MDBListRatingRequestDto
import com.nina.tv.domain.model.MDBListRatings
import com.nina.tv.domain.model.MDBListRatingsResult
        ...
        val imdbId = resolveImdbId(
            meta = Meta(
                ...
                type = when (normalizeMediaType(itemType)) {
                    "show" -> com.nina.tv.domain.model.ContentType.SERIES
                    else -> com.nina.tv.domain.model.ContentType.MOVIE
                },
                name = itemId,
                poster = null,
                posterShape = com.nina.tv.domain.model.PosterShape.POSTER,
                background = null,
                logo = null,
                description = null,
                releaseInfo = null,
