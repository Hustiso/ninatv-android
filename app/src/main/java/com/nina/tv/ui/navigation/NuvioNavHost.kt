package com.nina.tv.ui.navigation
...
import com.nina.tv.ui.screens.CatalogSeeAllScreen
import com.nina.tv.ui.screens.LayoutSelectionScreen
import com.nina.tv.ui.screens.detail.MetaDetailsScreen
import com.nina.tv.ui.screens.home.HomeScreen
import com.nina.tv.ui.screens.addon.AddonManagerScreen
import com.nina.tv.ui.screens.addon.CatalogOrderScreen
import com.nina.tv.ui.screens.library.LibraryScreen
import com.nina.tv.ui.screens.player.PlayerScreen
import com.nina.tv.ui.screens.plugin.PluginScreen
import com.nina.tv.ui.screens.search.DiscoverScreen
import com.nina.tv.ui.screens.search.SearchScreen
import com.nina.tv.ui.screens.settings.AboutScreen
import com.nina.tv.ui.screens.settings.LayoutSettingsScreen
import com.nina.tv.ui.screens.settings.PlaybackSettingsScreen
...
fun NinaNavHost(
    ...
    NavHost(
        ...
        composable(Screen.Search.route) { backStackEntry ->
            val searchViewModel: com.nina.tv.ui.screens.search.SearchViewModel =
        ...
        composable(Screen.Collections.route) {
            com.nina.tv.ui.screens.collection.CollectionManagementScreen(
        ...
        composable(
            ...
            com.nina.tv.ui.screens.collection.CollectionEditorScreen(
                onBack = { navController.popBackStack() }
            )
        }
        ...
        composable(
            ...
            com.nina.tv.ui.screens.collection.FolderDetailScreen(
                onNavigateToDetail = { itemId, itemType, addonBaseUrl ->
                    navController.navigate(Screen.Detail.createRoute(itemId, itemType, addonBaseUrl))
                },
                onBack = { navController.popBackStack() }
        ...
        composable(
            ...
            val searchViewModel: com.nina.tv.ui.screens.search.SearchViewModel? =
                if (searchBackStackEntry != null) {
                    androidx.hilt.navigation.compose.hiltViewModel<com.nina.tv.ui.screens.search.SearchViewModel>(searchBackStackEntry)
                } else null
