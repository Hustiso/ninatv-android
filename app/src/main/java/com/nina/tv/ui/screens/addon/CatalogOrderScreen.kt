        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    ...
                    color = if (item.isDisabled) NinaColors.TextSecondary else NinaColors.TextPrimary
                )
            ...
            Row(
                ...
                Button(
                    ...
                    colors = ButtonDefaults.colors(
                        containerColor = NinaColors.BackgroundCard,
                        contentColor = if (item.isDisabled) NinaColors.Success else NinaColors.TextSecondary,
                        focusedContainerColor = NinaColors.FocusBackground,
                        focusedContentColor = if (item.isDisabled) NinaColors.Success else NinaColors.Error
                    ),
                    border = ButtonDefaults.border(
                        focusedBorder = Border(
                            border = BorderStroke(2.dp, NinaColors.FocusRing),
