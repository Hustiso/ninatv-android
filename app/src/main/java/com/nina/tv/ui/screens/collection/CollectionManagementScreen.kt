...
import com.nina.tv.data.local.ValidationResult
    ...
    Column(
        ...
        Row(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                            ...
                            try {
                                ...
                                withContext(Dispatchers.IO) {
                                    ...
                                    resolver.delete(
                                        ...
                                        arrayOf("nina-collections.json")
                                    )
                                    // Write new file
                                    val values = android.content.ContentValues().apply {
                                        put(android.provider.MediaStore.Downloads.DISPLAY_NAME, "nina-collections.json")
                ...
                NinaButton(onClick = { viewModel.showImportDialog() }) {
...
private fun ImportContent(
    ...
    Column(
        ...
        Row(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                NinaButton(onClick = onBack) { Text(stringResource(R.string.collections_cancel)) }
            }
        }
        ...
        LazyColumn(
                        ...
                        if (mode == importMode) {
                            Button(
                                ...
                                colors = ButtonDefaults.colors(
                                    ...
                                    contentColor = NinaColors.Background,
                                    focusedContainerColor = NinaColors.Primary,
                                    focusedContentColor = NinaColors.Background
                                ),
                                border = ButtonDefaults.border(
                                    focusedBorder = Border(
                                        border = BorderStroke(2.dp, NinaColors.FocusRing),
                            ...
                            NinaButton(onClick = { onModeChange(mode) }) {
                                Text(label)
                            }
                        }
                    }
            ...
            item {
                when (importMode) {
                    ImportMode.PASTE -> {
                        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                            NinaButton(onClick = onPaste) { Text(stringResource(R.string.collections_paste_clipboard)) }
                            if (importText.isNotBlank()) {
                                NinaButton(onClick = onValidate) { Text(stringResource(R.string.collections_validate)) }
                            }
                        }
                        ...
                        Surface(
                            shape = RoundedCornerShape(12.dp),
                            colors = SurfaceDefaults.colors(containerColor = NinaColors.BackgroundElevated),
                            border = Border(
                                border = BorderStroke(1.dp, if (importError != null) NinaColors.Error else NinaColors.Border),
                                shape = RoundedCornerShape(12.dp)
                            ),
                            modifier = Modifier
                                .fillMaxWidth()
                            ...
                            Box(modifier = Modifier.padding(12.dp)) {
                                BasicTextField(
                                    ...
                                    cursorBrush = SolidColor(NinaColors.Primary),
                    ...
                    ImportMode.FILE -> {
                        ...
                        NinaButton(onClick = onPickFile) { Text(stringResource(R.string.collections_load_file)) }
            ...
            if (validationResult != null && validationResult.valid) {
                item {
                    ...
                    Surface(
                        ...
                        border = Border(
                            border = BorderStroke(1.dp, NinaColors.Primary),
                            shape = RoundedCornerShape(12.dp)
                        ),
                        modifier = Modifier.fillMaxWidth()
                    ) {
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Spacer(modifier = Modifier.height(12.dp))
                            NinaButton(onClick = onConfirmImport) {
