...
import com.nina.tv.core.qr.QrCodeGenerator
import com.nina.tv.data.local.TraktSettingsDataStore
import com.nina.tv.data.local.WatchProgressSource
...
fun TraktScreen(
    ...
    val strWatchProgressNina = stringResource(R.string.trakt_watch_progress_source_nina)
    ...
    val watchProgressFormatter: (WatchProgressSource) -> String = { source ->
        when (source) {
            ...
            WatchProgressSource.NINA_SYNC -> strWatchProgressNina
        }
    }
    ...
    Row(
        ...
        Column(
            modifier = Modifier
                .weight(0.55f)
                .fillMaxHeight()
                .border(1.dp, NinaColors.Border.copy(alpha = 0.5f), RoundedCornerShape(18.dp))
                .background(NinaColors.BackgroundElevated.copy(alpha = 0.35f), RoundedCornerShape(18.dp))
                .padding(20.dp)
        ) {
            ...
            Column(
                ...
                if (uiState.mode == TraktConnectionMode.AWAITING_APPROVAL) {
                    ...
                    Button(
                        ...
                        modifier = Modifier.focusRequester(primaryFocusRequester),
                        colors = ButtonDefaults.colors(
                            containerColor = NinaColors.Primary,
    ...
    if (showWatchProgressDialog) {
        NinaDialog(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                Button(
                    onClick = {
                        viewModel.onWatchProgressSourceSelected(WatchProgressSource.NINA_SYNC)
                        showWatchProgressDialog = false
                    },
                    colors = ButtonDefaults.colors(
                        containerColor = if (uiState.watchProgressSource == WatchProgressSource.NINA_SYNC) {
                            NinaColors.Primary
                        } else {
                            NinaColors.BackgroundCard
                        },
                        contentColor = if (uiState.watchProgressSource == WatchProgressSource.NINA_SYNC) {
                            Color.Black
                        } else {
                            NinaColors.TextPrimary
                        }
                    ...
                    Text(stringResource(R.string.trakt_watch_progress_source_nina))
                }
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    ...
                    Row(
                        ...
                        rowOptions.forEach { days ->
                            ...
                            Button(
                                ...
                                colors = ButtonDefaults.colors(
                                    containerColor = if (selected) NinaColors.Primary else NinaColors.BackgroundCard,
                                    contentColor = if (selected) Color.Black else NinaColors.TextPrimary
                                )
                            ) {
        ...
        NinaDialog(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                Button(
                    ...
                    colors = ButtonDefaults.colors(
                        containerColor = if (uiState.showUnairedNextUp) NinaColors.Primary else NinaColors.BackgroundCard,
                        contentColor = if (uiState.showUnairedNextUp) Color.Black else NinaColors.TextPrimary
                    ),
                    modifier = Modifier.fillMaxWidth()
                ) {
        ...
        NinaDialog(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                Button(
                    ...
                    colors = ButtonDefaults.colors(
                        containerColor = if (uiState.showMetaComments) NinaColors.Primary else NinaColors.BackgroundCard,
                        contentColor = if (uiState.showMetaComments) Color.Black else NinaColors.TextPrimary
                    ),
                    modifier = Modifier.fillMaxWidth()
                ) {
    ...
    Column(
        ...
        Box(
            modifier = Modifier
                .fillMaxWidth()
                .height(1.dp)
                .background(NinaColors.Border.copy(alpha = 0.8f))
        )
        Row(
            modifier = Modifier.fillMaxWidth(),
            verticalAlignment = Alignment.CenterVertically
                ...
                if (index != values.lastIndex) {
                    Box(
                        modifier = Modifier
                            .width(1.dp)
                            .height(44.dp)
                            .background(NinaColors.Border.copy(alpha = 0.75f))
                    )
                }
            }
        }
