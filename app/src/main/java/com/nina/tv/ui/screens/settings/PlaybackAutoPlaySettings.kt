                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                Text(
                                    text = title,
                                    color = if (isSelected || isFocused) NinaColors.Primary else NinaColors.TextPrimary,
                                    style = MaterialTheme.typography.bodyLarge
                                )
                                Spacer(modifier = Modifier.height(4.dp))
                                Text(
    ...
    NinaDialog(
        ...
        Column(
            ...
            Card(
                ...
                colors = CardDefaults.colors(
                    containerColor = if (selected.isEmpty()) NinaColors.FocusBackground else NinaColors.BackgroundCard,
                    focusedContainerColor = NinaColors.FocusBackground
                ),
                shape = CardDefaults.shape(shape = androidx.compose.foundation.shape.RoundedCornerShape(10.dp)),
                scale = CardDefaults.scale(focusedScale = 1f)
                ...
                Row(
                    ...
                    Text(
                        text = allLabel,
                        color = if (selected.isEmpty()) NinaColors.Primary else NinaColors.TextPrimary,
                        style = MaterialTheme.typography.bodyLarge,
                        modifier = Modifier.weight(1f)
                    )
                    if (selected.isEmpty()) {
                    ...
                    items(
                        ...
                        Card(
                            ...
                            Text(
                                ...
                                color = if (isFocused) NinaColors.Primary else NinaColors.TextPrimary
                            )
                        }
                    }
                }
                ...
                Card(
                    ...
                    Box(modifier = Modifier.padding(horizontal = 14.dp, vertical = 12.dp)) {
                        BasicTextField(
                            ...
                            textStyle = MaterialTheme.typography.bodyMedium.copy(color = NinaColors.TextPrimary),
                            cursorBrush = SolidColor(if (isInputFocused) NinaColors.Primary else Color.Transparent),
