package com.nina.tv.ui.screens.addon
...
fun AddonManagerScreen(
    ...
    val manageFromPhoneSubtitle = if (webConfigMode == com.nina.tv.core.server.AddonConfigServer.WebConfigMode.COLLECTIONS_ONLY) {
    ...
    val qrInstruction = if (webConfigMode == com.nina.tv.core.server.AddonConfigServer.WebConfigMode.COLLECTIONS_ONLY) {
