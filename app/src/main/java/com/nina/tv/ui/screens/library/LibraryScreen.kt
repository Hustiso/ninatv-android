package com.nina.tv.ui.screens.library
...
import com.nina.tv.domain.model.LibraryListTab
import com.nina.tv.domain.model.LibrarySourceMode
import com.nina.tv.domain.model.PosterShape
import com.nina.tv.domain.model.TraktListPrivacy
import com.nina.tv.ui.components.EmptyScreenState
import com.nina.tv.ui.components.GridContentCard
import com.nina.tv.ui.components.PosterCardDefaults
...
import com.nina.tv.ui.util.formatAddonTypeLabel
import com.nina.tv.ui.util.localizedGenreLabel
        ...
        item(span = { GridItemSpan(maxLineSpan) }) {
            Row(
                ...
                Text(
                    ...
                    color = if (showBuiltInHeader) NinaColors.TextPrimary else Color.Transparent,
                ...
                Text(
                    text = when {
                        ...
                        uiState.isNinaAccount -> "NINA"
                        else -> stringResource(R.string.library_source_local)
                    },
                    style = MaterialTheme.typography.labelLarge,
                    color = if (showBuiltInHeader) NinaColors.TextTertiary else Color.Transparent,
    ...
    if (!transientMessage.isNullOrBlank()) {
        Box(
            ...
            Text(
                ...
                modifier = Modifier
                    .padding(top = 24.dp)
                    .background(NinaColors.BackgroundElevated, RoundedCornerShape(10.dp))
            ...
            Column(
                ...
                Row(
                    ...
                    Icon(
                        ...
                        tint = if (isFocused) NinaColors.FocusRing else NinaColors.TextSecondary
                    )
                }
            }
        }
        ...
        DropdownMenu(
            ...
            options.forEach { option ->
                ...
                val itemTextColor = when {
                    isOptionFocused -> NinaColors.OnSecondary
                    isSelected -> NinaColors.TextPrimary
                    else -> NinaColors.TextPrimary
                }
                val itemBackgroundColor = when {
                    isOptionFocused -> NinaColors.Secondary
                    isSelected -> NinaColors.FocusBackground
                ...
                DropdownMenuItem(
                    ...
                    colors = MenuDefaults.itemColors(
                        ...
                        disabledTextColor = NinaColors.TextDisabled
                    )
                )
            }
        }
...
private fun ManageListsDialog(
    ...
    Dialog(onDismissRequest = onDismiss) {
        Box(
            modifier = Modifier
                .width(620.dp)
                .background(NinaColors.BackgroundElevated, RoundedCornerShape(16.dp))
                .padding(24.dp)
        ) {
            Column(verticalArrangement = Arrangement.spacedBy(14.dp)) {
                ...
                if (personalTabs.isEmpty()) {
                    Text(
                        ...
                        style = MaterialTheme.typography.bodyMedium,
                        color = NinaTheme.extendedColors.textSecondary
                    )
                } else {
                    LazyColumn(
                        modifier = Modifier
                        ...
                        items(personalTabs, key = { it.key }) { tab ->
                            ...
                            Button(
                                ...
                                colors = ButtonDefaults.colors(
                                    containerColor = if (selected) NinaColors.FocusBackground else NinaColors.BackgroundCard,
                                    contentColor = NinaColors.TextPrimary
                                )
                            ) {
                                Text(
    ...
    NinaDialog(
        ...
        androidx.compose.material3.OutlinedTextField(
            ...
            colors = androidx.compose.material3.OutlinedTextFieldDefaults.colors(
                focusedTextColor = NinaColors.TextPrimary,
                unfocusedTextColor = NinaColors.TextPrimary,
                focusedContainerColor = NinaColors.BackgroundCard,
                unfocusedContainerColor = NinaColors.BackgroundCard,
                focusedBorderColor = NinaColors.FocusRing,
                unfocusedBorderColor = NinaColors.Border,
                focusedLabelColor = NinaColors.TextSecondary,
                unfocusedLabelColor = NinaColors.TextTertiary,
                cursorColor = NinaColors.FocusRing
            )
        )
