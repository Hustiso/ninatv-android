...
import com.nina.tv.ui.components.ContinueWatchingCard
import com.nina.tv.ui.components.MonochromePosterPlaceholder
import com.nina.tv.ui.components.TrailerPlayer
import com.nina.tv.ui.components.rememberArtworkBackedCardGlow
import com.nina.tv.LocalSidebarExpanded
...
internal fun ModernRowSection(
    ...
    Column {
        ...
        val textColor = remember { NinaColors.TextPrimary }
...
private fun ModernCarouselCard(
    ...
    val backgroundCardColor = NinaColors.BackgroundCard
