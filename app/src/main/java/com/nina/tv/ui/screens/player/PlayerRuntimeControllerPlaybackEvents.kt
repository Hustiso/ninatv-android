...
import com.nina.tv.data.repository.extractYear
import com.nina.tv.data.repository.parseContentIds
import com.nina.tv.data.repository.toTraktIds
        ...
        PlayerEvent.OnRetry -> {
            ...
            if (isTorrentStream && currentInfoHash != null) {
                ...
                launchTorrentSourceStream(
                    stream = com.nina.tv.domain.model.Stream(
...
internal fun PlayerRuntimeController.buildStreamInfoData(): StreamInfoData {
    ...
    return StreamInfoData(
        ...
        playerEngine = when (currentInternalPlayerEngine) {
            com.nina.tv.data.local.InternalPlayerEngine.EXOPLAYER -> context.getString(R.string.playback_engine_exoplayer)
            com.nina.tv.data.local.InternalPlayerEngine.MVP_PLAYER -> context.getString(R.string.playback_engine_mvplayer)
            com.nina.tv.data.local.InternalPlayerEngine.AUTO -> null
        }
    )
}
