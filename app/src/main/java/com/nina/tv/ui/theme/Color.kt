 ...
 */
class NinaColorScheme(palette: ThemeColorPalette) {
...
/**
 * Legacy NinaColors object for backwards compatibility.
 * Components should migrate to using NinaTheme.colors instead.
...
object NinaColors {
    ...
    val Background: Color
        @Composable
        @ReadOnlyComposable
        get() = NinaTheme.colors.Background

    val BackgroundElevated: Color
        @Composable
        @ReadOnlyComposable
        get() = NinaTheme.colors.BackgroundElevated

    val BackgroundCard: Color
        @Composable
        @ReadOnlyComposable
        get() = NinaTheme.colors.BackgroundCard
    ...
    val Secondary: Color
        @Composable
        @ReadOnlyComposable
        get() = NinaTheme.colors.Secondary

    val SecondaryVariant: Color
        @Composable
        @ReadOnlyComposable
        get() = NinaTheme.colors.SecondaryVariant

    val OnSecondary: Color
        @Composable
        @ReadOnlyComposable
        get() = NinaTheme.colors.OnSecondary

    val OnSecondaryVariant: Color
        @Composable
        @ReadOnlyComposable
        get() = NinaTheme.colors.OnSecondaryVariant

    val FocusRing: Color
        @Composable
        @ReadOnlyComposable
        get() = NinaTheme.colors.FocusRing

    val FocusBackground: Color
        @Composable
        @ReadOnlyComposable
        get() = NinaTheme.colors.FocusBackground

    val BorderFocused: Color
        @Composable
        @ReadOnlyComposable
        get() = NinaTheme.colors.BorderFocused
}
