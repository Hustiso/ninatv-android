...
import com.nina.tv.ui.screens.plugin.PluginScreenContent
...
private fun PluginsSettingsContent() {
    val pluginViewModel: com.nina.tv.ui.screens.plugin.PluginViewModel = hiltViewModel()
...
private fun AccountSettingsInline(
    ...
    val accountViewModel: com.nina.tv.ui.screens.account.AccountViewModel = hiltViewModel()
    ...
    Column(
        ...
        SettingsGroupCard(modifier = Modifier.fillMaxSize()) {
            com.nina.tv.ui.screens.account.AccountSettingsContent(
