...
internal fun PlayerRuntimeController.attachMpvView(view: NinaMpvSurfaceView?) {
...
private fun PlayerRuntimeController.performPendingMpvHardRestartIfNeeded(view: NinaMpvSurfaceView): Boolean {
