...
import com.nina.tv.data.remote.api.AniSkipApi
import com.nina.tv.data.remote.api.AnimeSkipApi
import com.nina.tv.data.remote.api.ArmApi
import com.nina.tv.data.remote.api.DonationsApi
import com.nina.tv.data.remote.api.GitHubReleaseApi
import com.nina.tv.data.remote.api.TraktApi
import com.nina.tv.data.remote.api.TrailerApi
import com.nina.tv.data.remote.api.IntroDbApi
import com.nina.tv.data.remote.api.ImdbTapframeApi
import com.nina.tv.data.remote.api.MDBListApi
import com.nina.tv.data.remote.api.ParentalGuideApi
import com.nina.tv.data.remote.api.SeriesGraphApi
import com.nina.tv.data.remote.api.TmdbApi
...
import com.nina.tv.core.network.IPv4FirstDns
import java.io.File
...
object NetworkModule {
    ...
    fun provideTraktOkHttpClient(
        ...
        .addInterceptor { chain ->
            ...
            val newRequest = request.newBuilder()
                ...
                .header("User-Agent", "Nina/$version")
    ...
    fun provideRetrofit(okHttpClient: OkHttpClient, moshi: Moshi): Retrofit =
        Retrofit.Builder()
            .baseUrl("https://placeholder.nina.tv/")
            .client(okHttpClient)
