...
val releaseStoreFilePath = env("NINA_RELEASE_STORE_FILE")
    ?: localProperties.getProperty("NINA_RELEASE_STORE_FILE")
val releaseKeyAliasValue = env("NINA_RELEASE_KEY_ALIAS")
    ?: localProperties.getProperty("NINA_RELEASE_KEY_ALIAS", "ninatv")
val releaseKeyPasswordValue = env("NINA_RELEASE_KEY_PASSWORD")
    ?: localProperties.getProperty("NINA_RELEASE_KEY_PASSWORD", "815787")
val releaseStorePasswordValue = env("NINA_RELEASE_STORE_PASSWORD")
    ?: localProperties.getProperty("NINA_RELEASE_STORE_PASSWORD", "815787")

android {
    namespace = "com.nina.tv"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.nina.tv"
        minSdk = 24
        targetSdk = 36
        versionCode = 58
        ...
        buildConfigField("String", "TV_LOGIN_WEB_BASE_URL", "\"${localProperties.getProperty("TV_LOGIN_WEB_BASE_URL", "https://app.nina.tv/tv-login")}\"")
    ...
    signingConfigs {
        create("release") {
            ...
            storeFile = releaseStoreFilePath?.let(::file) ?: file("../ninatv.jks")
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "TV_LOGIN_WEB_BASE_URL", "\"${devProperties.getProperty("TV_LOGIN_WEB_BASE_URL", "https://app.nina.tv/tv-login")}\"")
...
androidComponents {
    onVariants(selector().withBuildType("debug")) { variant ->
        variant.applicationId.set("com.ninadebug.com")
    }
}
